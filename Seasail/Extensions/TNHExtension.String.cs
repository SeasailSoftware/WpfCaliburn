...
namespace Seasail.Extensions
{
    ...
    public static partial class TNHExtension
    {
        ...
        public static bool IsEhMc17At(this string buffer)
        {
            return string.Compare(buffer, "USB-SERIAL CH340", StringComparison.CurrentCultureIgnoreCase) == 0;
        }
